...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Dialed In Sports - Expert Sports Betting Analytics & Predictions</title>
        <meta name="description" content="Premium sports betting analytics for College Football, NFL, College Basketball, and College Baseball. Expert picks and analysis starting at $25/month." />
        <meta name="keywords" content="sports betting analytics, college football picks, NFL predictions, college basketball betting, college baseball betting, sports handicapping, betting discord" />
      ...
      <div className="home">
        {/* Keep all your existing sections, just add some semantic improvements */}
        <main>
          <section className="hero" aria-label="Introduction">
            <div className="hero__content">
              <h1>
                <span className="company-name">Dialed In Sports</span>
                Expert Sports Analytics for Smarter Betting
              </h1>
              <p>Specialized analysis in College Football, College Basketball, College Baseball, and NFL</p>
              <button className="cta-button" onClick={handleContactClick} aria-label="Contact Us">Contact Us</button>
            </div>
          </section>

          {/* Your existing sections with added ARIA labels */}
          <section className="sports-coverage" aria-label="Sports Coverage">
          ...
          <section className="discord-access" aria-label="Pricing">
          ...
          {`
            {
              ...
              "mainEntity": [
                {
                  "@type": "Question",
                  "name": "When are picks posted?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Picks are posted weekly in our Discord channel, typically several hours before game time."
                  }
                },
                {
                  "@type": "Question",
                  ...
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "We cover College Football, NFL, College Basketball, and College Baseball."
                  }
                }
                // ... add other FAQ items
              ]
          ...
          {`
            {
              "@context": "https://schema.org",
              "@type": "Organization",
              "name": "Dialed In Sports",
              "description": "Premium sports betting analytics service",
              "url": "https://dialedinsports.com",
              "priceRange": "$25/month",
